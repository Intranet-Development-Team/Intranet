...
<body class="container pt-4">
  ...
  if ($current->accessstatus)
  {
    if (isset($_GET["id"]) && file_exists("../Blog/Blogs/" . $_GET["id"] . ".txt"))
    {
      ...
      </div><small class="text-muted" style="font-weight:500;display:block;">Moderators are always able to see all the blogs for moderation purpose.</small></div></div><button class="w-100 btn btn-lg btn-primary" name="submit" id="submitbtn">Submit</button></form>';
      }
      else
      {
